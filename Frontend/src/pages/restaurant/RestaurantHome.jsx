          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={6} md={3}>
              <Box sx={{ textAlign: "center" }}>
                ...
                <Typography variant="body2" sx={{ color: "#555" }}>
                  A classic Roman dish with creamy egg sauce, crispy pancetta,
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Box sx={{ textAlign: "center" }}>
                ...
                <Typography variant="body2" sx={{ color: "#555" }}>
                  Silky smooth Alfredo sauce with butter, cream, and Parmesan
                  over tender fettuccine.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
        ...
        >
          ...
          >
            ...
            <Grid item xs={12} md={8}>
              ...
              >
                Giuseppe Di Stefano was born in a bowl of ravioli in the heart
                of Rome. He grew up surrounded by the sights, sounds, and smells
                of his familys restaurant, where he learned to cook from his
                grandmother, Nonna Maria. Giuseppes passion for food and cooking
                led him to study at the prestigious Culinary Institute of Italy,
                where he honed his skills in the art of pasta-making. After
                working in some of the finest restaurants in Rome, Giuseppe
                moved to Toronto to share his love of Italian cuisine with the
                world. Today, he is the head chef at Gustosa, where he creates
                delicious dishes that transport diners to the streets of Rome
                with every bite.
              </Typography>
            </Grid>
          </Grid>
